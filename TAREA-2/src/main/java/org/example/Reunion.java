...
/**
 * Clase abstracta {@code Reunion}, la cual representara una reunión.
 * Esta contara con distintos atributos, tales como la fecha, la hora prevista de la reunión, la duración
 * prevista, el horario de inicio y final de la reunión. Además de contar con tres listas, una para almacenar
 ...
 * {@link Empleado} que será el organizador de la reunión, y esta podría ser de distintos tipos de reuniones.
 */
abstract public class Reunion {
    ...
    /**
     * Este metodo escribe en un archivo de texto la representación en cadena de la instancia actual del objeto.
     * La información escrita corresponde al resultado del método {@code toString()}.
     *
     * @param path la ruta del archivo en el que se escribirá el contenido.
