...
/**
 * CLase {@code Departamento} que representara un departamento específico de la empresa, a la cual,
 * ciertos empleados pertenecerán.
 * Esta clase implementa la interfaz {@link Invitable}.
 * Cada instancia de la clase contará con dos atributos: el nombre del departamento y un ArrayList con
